...
import cls from './CreateLegalEntitySwatzky.module.scss';
import { Text, TextAlign } from 'shared/ui/Text/Text';
import { Input } from 'shared/ui/Input/Input';
import { Button, ButtonThemes } from 'shared/ui/Button/Button';
import { Select, SelectOptionType } from 'shared/ui/Select/Select';

interface CreateLegalEntitySwatzkyProps {
	className?: string;
}

export const CreateLegalEntitySwatzky: React.FC<CreateLegalEntitySwatzkyProps> = (props) => {
	...
	return (
		<div className={classNames(cls.createLegalEntitySwatzky, {}, [className])}>
