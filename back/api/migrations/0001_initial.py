# Generated by Django 4.1 on 2023-10-08 12:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.employee', verbose_name='Сотрудник, создавший отчет')),
        ...
        migrations.AddField(
            model_name='employee',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='performer', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь'),
        ),
        migrations.AddField(
            model_name='client',
            name='legal_entity',
        ...
        migrations.AddField(
            ...
            name='creator',
            field=models.ManyToManyField(blank=True, null=True, related_name='application_creator', to='api.employee', verbose_name='Создатель заявки'),
        ),
        migrations.AddField(
            model_name='application',
            name='documents',
        ...
        migrations.AddField(
            model_name='application',
            name='performer',
            field=models.ManyToManyField(blank=True, null=True, related_name='application_performer', to='api.employee', verbose_name='Исполнители'),
        ),
        migrations.AddField(
            model_name='application',
            name='work_materials',
